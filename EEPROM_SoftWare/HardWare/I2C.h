...
//#define IIC_SCL(x)          (GPIO_WriteBit(IIC_SCL_GPIO_PORT,IIC_SCL_GPIO_PIN,(BitAction)(x)))
//#define IIC_SDA(x)          (GPIO_WriteBit(IIC_SDA_GPIO_PORT,IIC_SDA_GPIO_PIN,(BitAction)(x)))
